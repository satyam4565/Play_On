	...
	return (
		<div className='min-h-screen bg-gradient-to-b from-gray-900 to-black relative'>
					...
					<div className="space-y-4">
						<div className="inline-block bg-gradient-to-r from-red-600/20 to-amber-600/20 px-4 py-2 rounded-full backdrop-blur-sm border border-red-500/30">
							<div className="flex items-center gap-2">
								...
								<span className="text-sm font-medium text-gray-300">The ultimate streaming experience</span>
							</div>
						</div>
				...
				<div className='lg:col-span-2 flex items-center justify-center'>
					<div className="relative">
						...
						<div className="absolute -bottom-6 -right-6 bg-gray-900/90 backdrop-blur-sm p-3 rounded-2xl border border-gray-800 flex items-center gap-3 shadow-xl">
							...
							<div>
								<p className="text-sm font-bold">Ultra HD</p>
			...
			<div className="bg-gradient-to-b from-gray-900 to-black py-24">
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						<h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-red-500 to-amber-500 bg-clip-text text-transparent inline-block">Why Choose PlayOn?</h2>
						<p className="text-gray-300 text-lg max-w-2xl mx-auto">Experience entertainment like never before with our cutting-edge streaming platform</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-1">
							...
							<p className="text-gray-400">Stream thousands of movies and TV shows anytime, anywhere.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-1">
							...
							<h3 className="text-xl font-bold mb-2">Download & Watch</h3>
							<p className="text-gray-400">Save your favorites and watch offline on your device.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-1">
							...
							<p className="text-gray-400">Watch on your TV, smartphone, tablet, or laptop seamlessly.</p>
						</div>
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-1">
							...
							<p className="text-gray-400">Create multiple profiles with customized parental controls.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="py-24 bg-gradient-to-b from-black to-gray-900">
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						<h2 className="text-3xl md:text-4xl font-bold mb-4">Choose Your <span className="bg-gradient-to-r from-red-500 to-amber-500 bg-clip-text text-transparent">Plan</span></h2>
						<p className="text-gray-300 text-lg max-w-2xl mx-auto">No contracts, no commitments. Upgrade or downgrade anytime.</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl overflow-hidden">
							<div className="p-6">
								...
								<p className="text-gray-400 text-sm mb-4">For individuals</p>
								...
								<ul className="space-y-3 mb-6">
									...
									<li className="flex items-center gap-2 text-gray-300">
										...
										<span className="text-gray-500">No downloads</span>
									</li>
								</ul>
							</div>
							<div className="px-6 pb-6">
								<button className="w-full py-3 border border-gray-700 rounded-xl hover:bg-gray-800 transition-colors">
									Get Started
								</button>
							</div>
						</div>
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-red-500/30 rounded-2xl overflow-hidden relative shadow-xl shadow-red-500/10 transform scale-105">
							<div className="absolute top-0 left-0 right-0 py-1 bg-gradient-to-r from-red-600 to-amber-600 text-center text-sm font-semibold">
								MOST POPULAR
							</div>
							<div className="p-6 pt-9">
								<h3 className="text-xl font-bold mb-1">Standard</h3>
								<p className="text-gray-400 text-sm mb-4">For couples and small families</p>
								<div className="flex items-baseline mb-4">
						...
						<div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl overflow-hidden">
							<div className="p-6">
								...
								<p className="text-gray-400 text-sm mb-4">For large families</p>
								<div className="flex items-baseline mb-4">
			...
			{/* Footer */}
			<footer className='py-12 bg-black text-gray-500 text-center'>
				<div className="max-w-7xl mx-auto px-6">
